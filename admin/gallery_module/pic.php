    ...
    <div class="subnavbar-inner">
      <div class="container">
        <ul class="mainnav"> 
          ...
          <li id="gallery"><a href="pic.php"><i class="fa fa-picture-o"></i><span>Gallery</span> </a> </li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-picture-o"></i> จัดการรูปภาพ</h3></div>
        <div class="panel-body">
          ...
          <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" aria-controls="report" role="tab" data-toggle="tab">เพิ่มรูปภาพข่าวสาร</a></li>
              <li role="presentation"><a href="#tab2" aria-controls="income" role="tab" data-toggle="tab">เพิ่มรูปภาพกิจกรรม</a></li>
              <li role="presentation"><a href="#tab3" aria-controls="pay" role="tab" data-toggle="tab">เพิ่มรูปภาพบทความ</a></li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane active" id="tab1" ng-controller="reportCtrl">
                ...
                <form id="tab1" class="form-horizontal" rule="form">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">เพิ่มรูปภาพข่าวสาร</label>
                    <div class="col-md-8">
                      <input type="file" name="head_news" class="form-control">
                    </div>
                  </div>
              ...
              <div role="tabpanel" class="tab-pane" id="tab2" ng-controller="reportCtrl">
                ...
                <form id="tab2" class="form-horizontal" rule="form">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">เพิ่มรูปภาพกิจกรรม</label>
                    <div class="col-md-8">
                      <input type="file" name="head_news" class="form-control">
                    </div>
                  </div>
              ...
              <div role="tabpanel" class="tab-pane" id="tab3" ng-controller="payCtrl">
                ...
                <form id="tab3" class="form-horizontal" rule="form" action="account_pay.php" method="post">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">เพิ่มรูปภาพบทความ</label>
                    <div class="col-md-8">
                      <input type="file" name="head_news" class="form-control">
                    </div>
                  </div>
