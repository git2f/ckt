    ...
    <div class="subnavbar-inner">
      <div class="container">
        <ul class="mainnav"> 
          ...
          <li id="article"><a href="article.php"><i class="fa fa-file-text-o"></i><span>บทความ</span> </a> </li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-file-text-o"></i> จัดการบทความ</h3></div>
        <div class="panel-body">
          ...
          <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" aria-controls="report" role="tab" data-toggle="tab">เพิ่มบทความ</a></li>
              <li role="presentation"><a href="#tab2" aria-controls="income" role="tab" data-toggle="tab">แก้ไขบทความ</a></li>
            </ul>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class='input-group date' id='date_start_news'>
                        <input type='text' class="form-control" name="date_start_news" value="<?=date("m/d/Y H:i:s");?>"/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class='input-group date' id='date_stop_news'>
                        <input type='text' class="form-control" name="date_stop_news" value="<?=date("m/d/Y H:i:s");?>"/>
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                      </div>
