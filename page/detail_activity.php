...
$sql = "select * from activity where pk_activity = ".$_GET[idactivity]." ";
...
?>
	...
	<?php
	$sql_img = "select * from gallery where pk_activity = ".$result[pk_activity]." ";
	$query_img = mysqli_query($con,$sql_img);
	$result_img = mysqli_fetch_assoc($query_img);
	?>

	<img class='lib-img-show' src='../img/activity/<?=$result_img[path_gallery];?>'>
	</div>
	<div class='col-md-12'>
	<div class='lib-row lib-header'>
	<?=$result[head_activity];?>
	<div class='lib-header-seperator'></div>			
	</div>
	<div class='lib-row lib-desc'>
	<?=$result[detail_activity];?>
	</div>
	</div>
	</div>
	</div>
